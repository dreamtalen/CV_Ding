...
\documentclass{resume_Stanford} % Use the custom resume.cls style
\usepackage{verbatim}
...
\newpagestyle{main}{            
    \sethead{Applicant: Yongming Ding}{}{Applying to: Department of Electrical Engineering}     %????
    %\headrule                                      % ????????
}
\pagestyle{main}
...
%\\\bm{$\diamond$} Major GPA: 4.00/4.00 \qquad \qquad \qquad \qquad \qquad \, \ \ $\diamond$ Overall GPA: 3.72/4.00
...
%\textbf{Languages} & English(TOEFL 105, GRE 153+170+3.0), Chinese(Native), Japanese(Intermediate) \\
